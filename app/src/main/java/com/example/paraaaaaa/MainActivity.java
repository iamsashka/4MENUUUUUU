...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_item1) {
                setFragment(new First());
                Toast.makeText(MainActivity.this, "Первый фрагмент", Toast.LENGTH_SHORT).show();
                return true;

            } else if (itemId == R.id.nav_item2) {
                setFragment(new SecondFragment());
                Toast.makeText(MainActivity.this, "Второй фрагмент", Toast.LENGTH_SHORT).show();
            } else if (itemId == R.id.nav_item3) {
                setFragment(new Third());
                Toast.makeText(MainActivity.this, "Третий фрагмент", Toast.LENGTH_SHORT).show();
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Toast.makeText(this, "Выбранные настройки", Toast.LENGTH_SHORT).show();
            return true;
